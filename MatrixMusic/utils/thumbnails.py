...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            circle = Image.open("MatrixMusic/assets/AFYONA.png")
            ...
            # fonts
            font1 = ImageFont.truetype("MatrixMusic/assets/font2.ttf", 30)
            ...
            image4.text(
                (10, 10), "𓏺𝗦𝗼𝘂𝗿𝗰𝗲ᯓ𝗩𝗘𝗡𝗢𝗠𖠛. ", fill="white", font=font1, align="left"
            )
            image4.text(
                (670, 150),
                "𓏺𝗦𝗼𝘂𝗿𝗰𝗲ᯓ𝗩𝗘𝗡𝗢𝗠𖠛.",
